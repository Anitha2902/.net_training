...
public class Program
{
    public static void Main()
    {
        ...
        {
            new Employee { EmpId = 1, EmpName = "Anitha", EmpCity = "canada", EmpSalary = 50000 },
            new Employee { EmpId = 2, EmpName = "Rohini", EmpCity = "Bangalore", EmpSalary = 60000 },
            new Employee { EmpId = 3, EmpName = "Ramesh", EmpCity = "Bangalore", EmpSalary = 80000 },
            new Employee { EmpId = 4, EmpName = "Jaswanth", EmpCity = "USA", EmpSalary = 45000 },
        };
