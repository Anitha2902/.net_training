...
namespace pro
{
    ...
    {
        private static string connectionString = "data source=ICS-LT-9HDQ4D3\\SQLEXPRESS; initial catalog=railwaysystem; User ID=sa; Password=12345678";
        ...
        private static void AdminLogin()
        {
            ...
            if (adminUsername == "Gayatri" && adminPassword == "12345") 
            {
